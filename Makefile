...
IMG ?= ghcr.io/fredericrous/ddns-updater-operator:$(VERSION)
...
docker-build: ## Build docker image with the manager.
	docker build -t ${IMG} .
	docker tag ${IMG} ghcr.io/fredericrous/ddns-updater-operator:latest

docker-push: ## Push docker image with the manager.
	docker push ${IMG}
	docker push ghcr.io/fredericrous/ddns-updater-operator:latest
...
.PHONY: all help manifests generate fmt vet lint test test-unit test-integration test-coverage build run docker-build docker-push install uninstall deploy undeploy controller-gen envtest golangci-lint
